...
from .service import (
    ...
    get_group,
    get_all_groups,
    update_group as update_group_svc,
    delete_group as delete_group_svc,
    add_user_to_group,
    remove_user_from_group,
    get_group_members,
    invite_user_to_group,
    search_groups as search_groups_svc,
)
...
def create_group(
    ...
    """
    return create_group_svc(group, user, session)
...
def read_group(
    ...
    """
    return get_group(group_id, user, session)
...
def read_all_groups(
    ...
    """
    return get_all_groups(user, session, q)
...
def update_group(
    ...
    """
    return update_group_svc(group_id, group, user, session)
...
def get_members(
    ...
    """
    return get_group_members(group_id, user, session)
...
def invite_to_group(
    ...
    """
    return invite_user_to_group(group_id, invite_data, user, session)
...
def search_groups(
    ...
    """
    return search_groups_svc(search_term, user, session)
