...
export function PreChatForm({ primaryColor, storeName, greeting, onSubmit }: PreChatFormProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center flex-1 p-6 bg-white">
      ...
      <h2 className="text-lg font-semibold text-gray-900 mb-1">{storeName}</h2>
      <p className="text-sm text-gray-500 text-center mb-6 px-4">{greeting}</p>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-xs space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full text-sm bg-gray-100 rounded-lg px-3 py-2.5 outline-none border-none focus:ring-2"
