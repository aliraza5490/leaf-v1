...
import { AdminStoreTable } from "@/components/admin/stores/store-table";
import { AdminStoreDialog } from "@/components/admin/stores/store-dialog";
import {
  getAdminStores,
  getAdminStoreStats,
  updateAdminStore,
} from "@/lib/admin/api";
import type { Store as StoreType, StoreUpdate, StoreStats } from "@/lib/admin/types";
