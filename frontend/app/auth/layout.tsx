  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
        ...
        <div className="relative z-10 max-w-sm">
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">Real-time product recommendations</p>
                <p className="text-sm text-primary-foreground/70">
      ...
      <div className="relative flex flex-col items-center justify-center p-6 md:p-10">
        {/* Mobile-only logo */}
        <Link href="/" className="absolute left-6 top-6 flex items-center gap-2 text-lg font-semibold text-primary lg:hidden">
